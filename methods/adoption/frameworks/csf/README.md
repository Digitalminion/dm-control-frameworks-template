...
<!--
    ...
    CSF-specific focus: Monitor checkbox changes to trigger documentation creation,
    coordinate with other frameworks in methods/adoption/frameworks/, and apply
    risk-based implementation strategies appropriate for NIST CSF 2.0.
-->
<!-- END AI INSTRUCTION -->
