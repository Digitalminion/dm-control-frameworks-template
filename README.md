...
<!-- 
    TOPICS: open-source-project, nist-documentation, template-repository, digital-minion
    CONTENT: overview, installation, usage, contributing, organization-template
    RELATED: development/, methods/, LICENSE
    RATING: foundational
    PURPOSE: Open Source Project Overview for NIST Documentation Template
    UPDATE: High
    Updated: 2025-08-04
-->
<!-- END AI FILE SUMMARY -->
...
<!-- BEGIN AI COMMENT -->
<!-- 
    OPEN SOURCE FOCUS: This README now serves as the main entry point for organizations
    wanting to use this repository as a template for their NIST documentation needs.
    Development-specific content has been moved to development/README.md.
-->
<!-- END AI COMMENT -->
